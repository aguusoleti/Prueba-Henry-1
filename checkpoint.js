...
return this.amigos.map(element=>element.nombre)
    ...
    getPromedioEdad() {
     ...
     return  this.amigos.reduce((valorAnterior, valorActual, indice)=>{
valorAnterior +=valorActual.edad
valorAnterior=valorAnterior/(indice+1)
...
var esBarato= producto=>if (producto.price === true){
